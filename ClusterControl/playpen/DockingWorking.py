...
# Form implementation generated from reading ui file 'ClusterGUI.ui'
#
# Created: Wed Jan 4 16:46:51 2006
...
class MainWindow(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        ### Start
        dw = QDockWindow(QDockWindow.InDock, self)
        dw.setOrientation(Qt.Horizontal)
        dw.setHorizontallyStretchable(True)
        #dw.setVerticallyStretchable(False)
        #dw.setResizeEnabled(True);
        dw.setCloseMode( QDockWindow.Always );
        dw.setNewLine(True)
        dw.setCaption(self.__tr("Cluster Tools"))

        self.mToolBox = QToolBox(dw,"mToolBox")
        dw.setWidget(self.mToolBox)

        self.setDockEnabled( dw, Qt.DockTop, False);
        #self.setDockEnabled( dw, Qt.DockBottom, False );
        self.moveDockWindow( dw, Qt.DockBottom );
        #print QDockWindow.__dict__
        
        self.mToolBox.setGeometry(QRect(10,50,192,176))
        self.mToolBox.setFrameShape(QToolBox.Panel)
        self.mToolBox.setFrameShadow(QToolBox.Sunken)
        self.mToolBox.setCurrentIndex(0)

        self.page1 = QWidget(self.mToolBox,"page1")
        self.page1.setBackgroundMode(QWidget.PaletteBackground)
        self.mToolBox.addItem(self.page1,QString.fromLatin1(""))

        self.page2 = QWidget(self.mToolBox,"page2")
        self.page2.setBackgroundMode(QWidget.PaletteBackground)
        self.mToolBox.addItem(self.page2,QString.fromLatin1(""))
    ...
    def languageChange(self):
        ...
        self.mToolBox.setItemLabel(self.mToolBox.indexOf(self.page1),self.__tr("Page 1"))
        self.mToolBox.setItemLabel(self.mToolBox.indexOf(self.page2),self.__tr("Page 2"))
