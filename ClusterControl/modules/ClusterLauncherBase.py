...
class Ui_ClusterLauncherBase(object):
   ...
   def retranslateUi(self, ClusterLauncherBase):
      ...
      self.mLaunchBtn.setText(self.tr("&Launch"))
      self.mKillBtn.setText(self.tr("&Kill Application"))
      self.mHelpBtn.setText(self.tr("&Help"))
      self.mTabWidget.setTabText(self.mTabWidget.indexOf(self.mLaunchTab), self.tr("Launch"))
      self.mAddBtn.setText(self.tr("&Add"))
      self.mRemoveBtn.setText(self.tr("&Remove"))
      self.mSaveBtn.setText(self.tr("&Save"))
      self.mTabWidget.setTabText(self.mTabWidget.indexOf(self.mEditTab), self.tr("Edit"))
